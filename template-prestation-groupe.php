 ...
 *
 * Template name: prestation-groupe
 *
 * @package storefront
 */
...
<main>
    ...
    <?php
            $args = array(
                'post_type' => 'prestations-groupe',
                'tax_query' => array(
                    array(
                        'taxonomy' => 'categorie-prestation',
                        'field' => 'slug',
                        'terms' => 'titre_prestation',
                    )
                ),
                'status' => 'publish',
                'posts_per_page' => '1',
    ...
    <section id="professionnels_banniere" style="background-image: url('<?php echo $feat_image; ?>')">
            ...
            ?>
        <div class="container">
            <h1><span><?php _e('L\'eMott pour les','wattever2021'); ?></span><br> <?php _e('Prestations de groupes','wattever2021'); ?></h1>
        </div>
    </section>
